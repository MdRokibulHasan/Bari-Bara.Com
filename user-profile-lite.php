  ...
  <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
      ...
      <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
        <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
          <div class="d-table m-auto">
            ...
            <span class="d-none d-md-inline ml-1">User Profile</span>
          </div>
        </a>
    ...
    <div class="nav-wrapper">
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link " href="user-add-post.html">
            <i class="material-icons">note_add</i>
            <span>Add New Post</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="user-mypost.html">
            <i class="material-icons">note_add</i>
            <span>My Post</span>
          </a>
        </li>
        ...
        <ul class="navbar-nav border-left flex-row ">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <img class="user-avatar rounded-circle mr-2" src="./admin/images/users/<?php echo $user_slice['user_img']; ?>" alt="User Avatar">
              <span class="d-none d-md-inline-block"><?php echo $user_slice['first_name'].' '.$user_slice['last_name']; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-small">
              <a class="dropdown-item" href="user-profile-lite.php">
                <i class="material-icons">&#xE7FD;</i> Profile</a>
              <a class="dropdown-item" href="user-home.php">
                <i class="material-icons">home</i> Home</a>
              <a class="dropdown-item" href="user-add-post.html">
          ...
          <div class="card card-small mb-4">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item p-3">
                <div class="row">
                  <div class="col">
                    <form action="admin/inc/adduser.php" method="POST" enctype="multipart/form-data">
                      <div class="form-row">
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="email" class="form-control" id="feEmailAddress" name="feEmailAddress" placeholder="example@gmail.com"> </div>
                        <div class="form-group col-md-6">
                          <label for="fePhone">Phone</label>
                          <input type="text" class="form-control" id="fePhone" name="fePhone" placeholder="Phone No."> </div>
                      </div>
                      <div class="form-group">
                        <label for="feInputAddress">Address</label>
                        <input type="text" class="form-control" id="feInputAddress" name="feInputAddress" placeholder=""> </div>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          <label for="feInputCity">City</label>
                          <input type="text" class="form-control" id="feInputCity" name="feInputCity"> </div>
                        <div class="form-group col-md-4">
                          <label for="feInputState">State</label>
                          <input type="text" class="form-control" id="feInputState" name="feInputState"> </div>
                        <div class="form-group col-md-2">
                          <label for="inputZip">Zip</label>
                          <input type="text" class="form-control" id="inputZip" name="inputZip"> </div>
                        <div class="form-group">
